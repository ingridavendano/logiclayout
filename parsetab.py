...
_lr_productions = [
  ...
  ('statement -> ID EQUALS expression','statement',3,'p_statement_assign','./compiler/parser.py',30),
  ('statement -> expression','statement',1,'p_statement_expr','./compiler/parser.py',46),
  ('expression -> NOT expression','expression',2,'p_expression_not','./compiler/parser.py',51),
  ('expression -> expression OR expression','expression',3,'p_expression_or','./compiler/parser.py',57),
  ('expression -> ID OR expression','expression',3,'p_expression_or','./compiler/parser.py',58),
  ('expression -> expression AND expression','expression',3,'p_expression_and','./compiler/parser.py',65),
  ('expression -> ID AND expression','expression',3,'p_expression_and','./compiler/parser.py',66),
  ('expression -> expression XOR expression','expression',3,'p_expression_xor','./compiler/parser.py',72),
  ('expression -> ID XOR expression','expression',3,'p_expression_xor','./compiler/parser.py',73),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','./compiler/parser.py',79),
  ('expression -> LBRACE expression RBRACE','expression',3,'p_expression_group','./compiler/parser.py',80),
  ('expression -> LBRACKET expression RBRACKET','expression',3,'p_expression_group','./compiler/parser.py',81),
  ('expression -> BIN','expression',1,'p_expression_literal','./compiler/parser.py',85),
  ('expression -> INT','expression',1,'p_expression_literal','./compiler/parser.py',86),
  ('expression -> TRUE','expression',1,'p_expression_literal','./compiler/parser.py',87),
  ('expression -> FALSE','expression',1,'p_expression_literal','./compiler/parser.py',88),
  ('expression -> ID','expression',1,'p_expression_id','./compiler/parser.py',93),
]
